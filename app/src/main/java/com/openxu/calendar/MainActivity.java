...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customMonth = (CustomMonth) findViewById(R.id.customMouth);
        listMonthValue.add("10");
        listMonthValue.add("20");
        listMonthValue.add("30");
        listMonthValue.add("40");
        listMonthValue.add("50");
        listMonthValue.add("60");
        listMonthValue.add("70");
        listMonthValue.add("80");
        listMonthValue.add("90");
        listMonthValue.add("100");
        listMonthValue.add("110");
        listMonthValue.add("120");

        try {
            customMonth.setDataList(listMonthValue);
        } catch (CustomMonth.DataListErrorException e) {
            e.printStackTrace();
        }
        customMonth.setYear(2019);
